...
async function findImages() {
  let roverSelect = getRover();
  let dateSelect = document.getElementById("picdate").value;

  let myURL =
    "https://api.nasa.gov/mars-photos/api/v1/rovers/" + roverSelect + "/photos?earth_date=" + dateSelect + "&page=1&api_key=DEMO_KEY";
